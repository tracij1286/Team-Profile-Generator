              ...
              },
              {
                ...
                validate: (officeNumberInput) => {
                  if (officeNumberInput) {
                    ...
                    console.log(
                      "Please enter a correct answer, the office number should be a number!"
                    );
                    return false;
                  }
                },
              ...
              },
              {
                ...
                validate: (githubInput) => {
                  if (githubInput) {
                    ...
                    console.log(
                      "Please enter the correct engineer's github username!"
                    );
                    return false;
                  }
                },
              ...
              },
              {
                ...
                validate: (schoolInput) => {
                  if (schoolInput) {
                    ...
                    console.log(
                      "Please enter the correct intern school's name!"
                    );
                    return false;
                  }
                },
